...
//
// The `magnitude` entry's alt is DELIBERATELY a runaway paragraph, well past
// VISUAL_ALT_MAX_CHARS. It is the only offline exercise of clampText(), so the
// ellipsis it draws on the projector — cut at a word boundary, not mid-word —
// is the test passing, along with the single warning it logs. Every other alt
// must stay well under the cap: a caption that merely runs long is meant to
// display in full, and shortening these entries would hide the bug this guard
